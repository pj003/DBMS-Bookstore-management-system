...
public class SelectFourth extends JFrame 
{
		...
		btnLoadReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					String sql = "select (select count(*) from f17_3_purchase where PROD_ID IN (select bprod_id from f17_3_books)) as BookCount,(select count(*) from f17_3_purchase where PROD_ID IN (select mprod_id from f17_3_merchandise)) as MerchCount from dual";
